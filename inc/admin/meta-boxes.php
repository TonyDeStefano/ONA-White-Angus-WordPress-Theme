...
function basic_add_custom_box() {
	...
	add_meta_box( 'basic-page-layout', __( 'Select Layout', 'ona-white-angus' ), 'basic_page_layout', 'page', 'side', 'default' );

	// Adding layout meta box for
	add_meta_box( 'basic-page-layout', __( 'Select Layout', 'ona-white-angus' ), 'basic_page_layout', 'post', 'side', 'default' );
...
function basic_get_default_page_layouts() {
	...
	$page_layout = array(
		...
		'center'         => array(
			'id'    => 'basic_page_layout',
			'value' => 'center',
			'label' => __( 'Centered Content', 'ona-white-angus' )
		)
	);
