	...
	foreach ( $meta_list as $meta ) {
		...
		switch ( $meta ) {
			...
			case 'category':
				...
				break;
			case 'comments':
				$meta_html[ $meta ] = '<span class="comments'. $preview .'"><a href="' . get_comments_link() . '">' . __( 'Comments', 'ona-white-angus' ) . ': ' . get_comments_number() . '</a></span>';
				break;
			case 'tags':
				$meta_html[ $meta ] = '<span class="tags'. $preview .'">' . get_the_tag_list( __( 'Tags: ', 'ona-white-angus' ), ', ' ) . '</span>';
				break;
		}
	}
