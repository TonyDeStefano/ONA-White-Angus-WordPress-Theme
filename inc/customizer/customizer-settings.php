...
function basic_customizer_init( $wp_customize ) {
	...
	$wp_customize->get_section( 'title_tagline' )->title = __( 'Site title', 'ona-white-angus' );
	...
	if ( class_exists( 'Basic_Group_Title_Control' ) ) {
		...
		$wp_customize->add_control( new Basic_Group_Title_Control( $wp_customize, 'basic_group_site_title', array(
			'label'    => __( 'Site title', 'ona-white-angus' ),
	...
	if ( class_exists( 'Basic_Group_Title_Control' ) ) {
		...
		$wp_customize->add_control( new Basic_Group_Title_Control( $wp_customize, 'basic_group_description_title', array(
			'label'    => __( 'Description', 'ona-white-angus' ),
			'section'  => 'title_tagline',
			'priority' => 12,
	...
	$wp_customize->add_control( 'title_position_control',
		array(
			...
			'label'    => __( "Title position", 'ona-white-angus' ),
			'section'  => 'title_tagline',
			'type'     => 'select',
			'choices'  => array(
				'left'   => __( "Left", 'ona-white-angus' ),
				'right'  => __( "Right", 'ona-white-angus' ),
				'center' => __( "Center", 'ona-white-angus' )
			),
			'priority' => 11,
		)
	);
	...
	$wp_customize->add_control( 'showsitedesc_control',
		array(
			'label'    => __( 'Show site description', 'ona-white-angus' ),
	...
	if ( class_exists( 'Basic_Group_Title_Control' ) ) {
		...
		$wp_customize->add_control( new Basic_Group_Title_Control( $wp_customize, 'basic_group_other_title', array(
			'label'    => __( 'Other', 'ona-white-angus' ),
			'section'  => 'title_tagline',
			'priority' => 22,
...
//			'default'           => 1,
	...
	$wp_customize->add_control( 'fix_header_height_control',
		array(
			...
			'label'    => __( "Set header height as background image size", 'ona-white-angus' ),
	...
	$wp_customize->add_control( 'header_image_repeat_control',
		array(
			...
			'label'    => __( "Image repeat", 'ona-white-angus' ),
			'section'  => 'header_image',
			'type'     => 'radio',
			'choices'  => array(
				'no-repeat' => __( "No repeat", 'ona-white-angus' ),
				'repeat-x'  => __( "Repeat", 'ona-white-angus' ),
			),
		)
	);
	...
	$wp_customize->get_section( 'background_image' )->title = __( 'Background', 'ona-white-angus' );
	...
	$wp_customize->add_section(
		'layout',
		array(
			'title'       => __( 'Design', 'ona-white-angus' ),
			'priority'    => 80,
			'description' => __( 'Main theme options', 'ona-white-angus' )
		)
	);
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		...
		BASIC_OPTION_NAME . '[maincolor]',
		array(
			'label'       => __( "Main color", 'ona-white-angus' ),
			'description' => __( "Choose main color", 'ona-white-angus' ),
			'section'     => 'layout',
	...
	if ( class_exists( 'Basic_Group_Title_Control' ) ) {
		...
		$wp_customize->add_control( new Basic_Group_Title_Control( $wp_customize, 'basic_group_layout_title', array(
			'label'       => __( 'Layout', 'ona-white-angus' ),
			'description' => __( 'Set up layout for site pages', 'ona-white-angus' ),
			'section'     => 'layout',
	...
	$wp_customize->add_control( 'show_sidebar_control',
		array(
			...
			'label'    => __( "Show sidebar on mobile", 'ona-white-angus' ),
			'section'  => 'layout',
			'type'     => 'checkbox',
		)
	);
	...
	$wp_customize->add_control( 'layout_post_control',
		array(
			...
			'label'           => __( "Layout on Post", 'ona-white-angus' ),
			'section'         => 'layout',
	...
	$wp_customize->add_control( 'layout_page_control',
		array(
			...
			'label'           => __( "Layout on Page", 'ona-white-angus' ),
			'section'         => 'layout',
	...
	$wp_customize->add_control( 'layout_default_control',
		array(
			...
			'label'           => __( "Global layout", 'ona-white-angus' ),
			'description'     => __( "It used when individual page layout not set", 'ona-white-angus' ),
			'section'         => 'layout',
			'type'            => 'select',
	...
	if ( class_exists( 'Basic_Group_Title_Control' ) ) {
		...
		$wp_customize->add_control( new Basic_Group_Title_Control( $wp_customize, 'basic_group_other_layout', array(
			'label'    => __( 'Other options', 'ona-white-angus' ),
			'section'  => 'layout',
//			'priority' => 10,
	...
	$wp_customize->add_control(
		new Basic_Sortable_Checkboxes_WPCC(
			...
			array(
				...
				'label'       => __( "Post meta", 'ona-white-angus' ),
				'description' => __( "What meta information display for posts", 'ona-white-angus' ),
				'section'     => 'layout',
				'choices'     => array(
					'date'     => __( "Published date", 'ona-white-angus' ),
					'author'   => __( "Post author", 'ona-white-angus' ),
					'category' => __( "Post categories", 'ona-white-angus' ),
					'comments' => __( "Comments count", 'ona-white-angus' ),
					'tags'     => __( "Post tags", 'ona-white-angus' )
				),
			)
		)
	);
	...
	$wp_customize->add_section(
		'social',
		array(
			'title'           => __( 'Social', 'ona-white-angus' ),
			'description'     => __( 'Social buttons', 'ona-white-angus' ),
			'priority'        => 81,
	...
	$wp_customize->add_control( 'add_social_meta_control',
		array(
			...
			'label'    => __( "Add Open Graph tags to &lt;head&gt;", 'ona-white-angus' ),
			'section'  => 'social',
			'type'     => 'checkbox',
		)
	);
	...
	$wp_customize->add_control( 'social_share_control',
		array(
			...
			'label'    => __( "Social share buttons after post", 'ona-white-angus' ),
			'section'  => 'social',
			'type'     => 'select',
			'choices'  => array(
				'hide'   => __( "Hide", 'ona-white-angus' ),
				'custom' => __( "Custom theme buttons", 'ona-white-angus' ),
				'yandex' => __( "Yandex Buttons", 'ona-white-angus' ),
			),
		)
	);
	...
	$wp_customize->add_control( 'title_before_socshare_control',
		array(
			...
			'label'    => __( "Custom text before share buttons", 'ona-white-angus' ),
			'section'  => 'social',
			'type'     => 'text',
		)
	);
	...
	$wp_customize->add_section(
		...
		array(
			'title'           => __( 'Structured Data', 'ona-white-angus' ),
			'priority'        => 82,
			'active_callback' => 'basic_is_singular'
		)
	);
	...
	$wp_customize->add_control( 'schema_mark_control',
		array(
			...
			'label'    => __( "Enable Schema.org mark up according CreativeWork->Article and Comment", 'ona-white-angus' ),
	...
	$wp_customize->add_control( 'markup_telephone_control',
		array(
			...
			'label'       => __( "Phone", 'ona-white-angus' ),
			'description' => __( "use in https://schema.org/Organization", 'ona-white-angus' ),
			'section'     => 'basic_structured_data',
			'type'        => 'text',
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'type'              => 'option',
			'default'           => __( 'Russia', 'ona-white-angus'),
			'sanitize_callback' => 'basic_sanitize_text',
			'transport'         => $transport
		)
	);
	$wp_customize->add_control( 'markup_adress_control',
		array(
			...
			'label'       => __( "Adress", 'ona-white-angus' ),
			'description' => __( "use in https://schema.org/Organization", 'ona-white-angus' ),
			'section'     => 'basic_structured_data',
			'type'        => 'text',
		)
	...
	$wp_customize->add_control( new WP_Customize_Image_Control(
		...
		array(
			...
			'label'       => __( 'Publisher logo', 'ona-white-angus' ),
			'description' => __( "use in https://schema.org/Organization", 'ona-white-angus' ),
			'section'     => 'basic_structured_data',
		)
	) );
	...
	$wp_customize->add_section(
		'basic_custom_code',
		array(
			'title'       => __( 'Custom codes', 'ona-white-angus' ),
			'description' => __( 'It help you setup custom scripts and styles', 'ona-white-angus' ),
			'priority'    => 91,
		)
	);
	...
	if ( class_exists( 'Basic_Group_Title_Control' ) ) {
		...
		$wp_customize->add_control( new Basic_Group_Title_Control( $wp_customize, 'basic_group_single_code', array(
			'label'           => __( 'Singular pages', 'ona-white-angus' ),
	...
	$wp_customize->add_setting(
		...
		array(
			'type'              => 'option',
			'default'           => "<!-- " . __( "Code before single post content", "ona-white-angus" ) . " -->",
	...
	$wp_customize->add_control( 'before_content_control',
		array(
			...
			'label'           => __( "Before content", 'ona-white-angus' ),
			'description'     => __( "Code before single post content", 'ona-white-angus' ),
			'section'         => 'basic_custom_code',
			'type'            => 'textarea',
			'active_callback' => 'basic_is_singular',
		)
	...
	$wp_customize->add_setting(
		...
		array(
			'type'              => 'option',
			'default'           => "<!-- " . __( "Code after single post content", "ona-white-angus" ) . " -->",
			'sanitize_callback' => 'basic_sanitize_html',
			'transport'         => $transport
		)
	);
	$wp_customize->add_control( 'after_content_control',
		array(
			...
			'label'           => __( "After content", 'ona-white-angus' ),
			'description'     => __( "Code after single post content", 'ona-white-angus' ),
			'section'         => 'basic_custom_code',
			'type'            => 'textarea',
			'active_callback' => 'basic_is_singular',
		)
	...
	if ( class_exists( 'Basic_Group_Title_Control' ) ) {
		...
		$wp_customize->add_control( new Basic_Group_Title_Control( $wp_customize, 'basic_group_global_code', array(
			'label'    => __( 'Global settings', 'ona-white-angus' ),
			'section'  => 'basic_custom_code',
	...
	$wp_customize->add_control( 'head_scripts_control',
		array(
			...
			'label'       => __( "Scripts in header", 'ona-white-angus' ),
			'description' => __( "HTML code in &lt;head&gt; tag", 'ona-white-angus' ),
			'section'     => 'basic_custom_code',
			'type'        => 'textarea',
		)
	);
	...
	$wp_customize->add_control( 'footer_scripts_control',
		array(
			...
			'label'       => __( "Scripts in site footer", 'ona-white-angus' ),
			'description' => __( "HTML code before &lt;/body&gt; tag", 'ona-white-angus' ),
			'section'     => 'basic_custom_code',
			'type'        => 'textarea',
		)
	);
	...
	$wp_customize->add_control( 'custom_styles_control',
		array(
			...
			'label'       => __( "Custom styles", 'ona-white-angus' ),
			'description' => __( "Add your custom CSS styles", 'ona-white-angus' ),
			'section'     => 'basic_custom_code',
			'type'        => 'textarea',
		)
	);
	...
	$wp_customize->add_section(
		'basic_footer_text',
		array(
			'title'       => __( 'Footer', 'ona-white-angus' ),
			'description' => __( 'Customize footer', 'ona-white-angus' ),
			'priority'    => 92,
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'type'              => 'option',
			'default'           => __( 'All rights reserved', 'ona-white-angus' ),
			'sanitize_callback' => 'basic_sanitize_text',
			'transport'         => $transport
		)
	);
	$wp_customize->add_control( 'copyright_text_control',
		array(
			...
			'label'    => __( "Copyright text", 'ona-white-angus' ),
	...
	$wp_customize->add_control( 'footer_counters_control',
		array(
			...
			'label'    => __( "Counters code", 'ona-white-angus' ),
			'section'  => 'basic_footer_text',
			'type'     => 'textarea',
		)
	);
	...
	$wp_customize->add_section(
		...
		array(
			'title'       => __( 'Design presets', 'ona-white-angus' ),
			'description' => __( 'Get child theme with individual design presets!', 'ona-white-angus' ),
			'priority'    => 200,
		)
	);
